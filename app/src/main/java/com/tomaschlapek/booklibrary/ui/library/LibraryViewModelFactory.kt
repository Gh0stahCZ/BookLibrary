...
class LibraryViewModelFactory @Inject constructor(var picasso: Picasso, val schedulersFacade: SchedulersFacade, val loadBookDetailUseCase: ILoadLibraryUseCase) : ViewModelProvider.Factory {
