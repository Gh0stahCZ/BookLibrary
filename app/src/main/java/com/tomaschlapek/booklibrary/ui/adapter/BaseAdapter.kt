 ...
 */
abstract class BaseAdapter<T>(protected var context: Context, itemList: MutableList<T>, private val emptyCheck: (Boolean) -> Unit = {}) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
  ...
  private val baseObserver: RecyclerView.AdapterDataObserver = object : RecyclerView.AdapterDataObserver() {
